...
class Parse:
    ...
    # object attrs
    def __init__(self, url:str='https://www.transfermarkt.com/sokol-saratov/startseite/verein/3834'):
        ...
        for i in self.playersDict:
            ...
            if jsonValue['success'] == True and 'marketValueDetails' in jsonValue['data']:
                ...
                if 'previous' not in jsonValue:
                    ...
                    self.playersDict[i]['deltaPercent, %'] = float(jsonMRKTDet['percentage'].split()[0].replace(',','.'))
